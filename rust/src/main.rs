...
// to the pope:
//
//     Gather all of the learned men in Pisa, 
//     especially Leonardo Fibonacci. In order 
//     for the crusades in the holy lands to be 
//     successful, these men must calculate the 
//     millionth number in Fibonacci's recurrence. 
//     Fail to do this, and your armies will never 
//     reclaim the holy land. It is His will.
//
...
// (now Istanbul), but they would never reclaim the holy land as 
// he desired.
//
...
// to find fib(n) if you already know fib(n + 1) and fib(n + 2)? Use this 
// to reason what value fib has to have for negative values.
